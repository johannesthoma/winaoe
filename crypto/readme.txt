This directory contains a self-signed certificate for use with 64-bit
Windows drivers in test mode. To put Windows into test mode,
...
The instructions below outline how to create a self-signed
certificate manually. You only need them if the certificate
in this directory should not work.
